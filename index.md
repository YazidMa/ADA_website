...
This is quite better, the fluctuations are not correlated with the number of quotes anymore! To be sure that our result is in accordance with the reality, we compared our results with a graph of Trump's popularity rating over time <a href="https://fr.wikipedia.org/wiki/Bonjour" /a>. Overall, the trend seems quite similar with what we have.
